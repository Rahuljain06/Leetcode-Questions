...
# The result is the last index of d.
        ...
        def backtrack(s,pos):
            ...
            for i in range(pos,len(s)):
                if s[pos:i+1] in words and backtrack(s,i+1):
                    return True
            return False
